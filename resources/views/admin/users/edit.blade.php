    ...
    <div class="container mx-auto">
        <div class="mb-6">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-2xl font-bold text-[#041E42]">Edit User</h1>
            </div>
                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" 
                               class="w-full border-gray-300 rounded-md shadow-sm focus:ring-[#041E42] focus:border-[#041E42]" 
                               required>
                    </div>
                            ...
                            <div class="border rounded-md p-4 cursor-pointer flex items-start" id="role-usher">
                                <div>
                                    <input type="radio" name="role" id="role-option-usher" value="usher" class="mr-2" 
                                           {{ old('role', $user->role) == 'usher' ? 'checked' : '' }}>
                                </div>
                                <div class="ml-2">
                    ...
                    <div class="border-t border-gray-200 pt-5">
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('admin.users') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </a>
